...
public final class StringHelper {
    ...
    public static String replaceOnce(String template, String placeholder, String replacement) {
        ...
        if (loc < 0) {
            ...
            return new StringBuilder(template.substring(0, loc)).append(replacement).append(template.substring(loc + placeholder.length())).toString();
        }
    }
    ...
    private static String generateAliasRoot(String description) {
        ...
        // Important to use Locale.ENGLISH. See HHH-8579. #toLowerCase() uses
        // the default Locale. Certain DBs
        // do not like non-ascii characters in aliases, etc., so ensure
        // consistency/portability here.
                .toLowerCase(Locale.ENGLISH).replace('/', '_') // entityNames
                // may now
                // include
                // slashes for
                // the
    ...
    public static String toLowerCase(String str) {
        // Important to use Locale.ENGLISH. See HHH-8579. #toLowerCase() uses
        // the default Locale. Certain DBs do not
        // like non-ascii characters in aliases, etc., so ensure
        // consistency/portability here.
    ...
    public static int findCount(String str, String token) {
        int count = 0;
